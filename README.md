...
Fork of https://github.com/schickling/dockerfiles/tree/master/mysql-backup-s3

Added a db size threshold to only backup db's below the threshold...
...
- `DB_SIZE_THRESHOLD` db threshold in mega bytes (default: 1000000)
